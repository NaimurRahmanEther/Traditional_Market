...
export default function NewProductPage() {
  ...
  useEffect(() => {
    ...
    const activeCategories = getAdminCategories().filter((category) => category.active);
    const activeDistricts = getAdminDistricts().filter((district) => district.active);
    const activeArtisans = getAdminArtisans().filter((artisan) => artisan.active);
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProducts = [newProduct, ...getAdminProducts()];
